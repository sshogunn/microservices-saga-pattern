...
public class RequestEquipmentTransaction implements Consumer<Sail> {
    ...
    public void accept(Sail sail) {
        log.info("Requested {} units of equipment for sailing. The event will be sent into equipment service.", sail.getVikings().size());
        val event = sail.requestEquipment();
